...
//
// Why: the lane-mcp server authenticates with
...
// MCP server acts as a DIFFERENT Lane account than the user's wallet/cards —
...
console.log('[lane] run /reload-plugins so lane-mcp reconnects with your account key.');
process.exit(0);
